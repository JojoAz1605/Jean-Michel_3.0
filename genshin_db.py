# Aptitudes
lundi = ["Amber", "Barbara", "Klee", "Sucrose", "Childe", "Diona", "Aloy", "Keqing", "Ningguang", "Qiqi", "Xiao", "Shenhe", "Yoimiya", "Kokomi", "Thomas", "Aether", "Lumine"]
mardi = ["Bennett", "Diluc", "Jean", "Mona", "Noelle", "Razor", "Eula", "Chongyun", "Xiangling", "Ganyu", "Hu Tao", "Kazuha", "Yun Jin", "Ayaka", "Sara", "Itto", "Ayato", "Aether", "Lumine"]
mercredi = ["Fischl", "Kaeya", "Lisa", "Venti", "Albedo", "Rosalia", "Beidou", "Xingqiu", "Zhongli", "Xinyan", "Yanfei", "Sayu", "Raiden", "Gorou", "Yae", "Aether", "Lumine"]
